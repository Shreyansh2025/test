...
import { Shield, School, LogOut } from "lucide-react";
import { useAuthContext } from "./AuthProvider";
import { cn } from "@/lib/utils";

const ITEMS = [
  { path: "/admin-dashboard", label: "Admin Dashboard", icon: Shield },
  { path: "/teacher-dashboard", label: "Teacher View", icon: School },
];
    ...
    <div className="flex h-screen bg-background">
      <aside className="w-64 border-r border-border bg-card p-3">
        <div className="px-3 py-4 border-b border-border mb-3">
          ...
          <p className="text-xs text-muted-foreground">Manage teachers and students</p>
        </div>
